      ...
      <Container className='row m-auto pb-5 px-0 mb-4'>
         {isLoading ? (
            <div className='d-flex ps-0 align-items-center'>
               <h1 className='fw-bolder px-4' style={{color: "#ff5555"}}>Today Events</h1>
               <Spinner animation="border" style={{color: "#ff5555"}}/>
            </div>
         ) : (
            <>
               <h1 className='fw-bolder px-4 pb-4' style={{color: "#ff5555"}}>Today Events</h1>
                              ...
                              <Card.Body className='position-relative flex align-items-center pt-2'>
                                 <div className='d-flex pt-2'>
                                    {item.title.length > 22 ? (
                                       <h2 className='col-10 fs-4 fw-bold'>{item.title.slice(0, 21)}...</h2>
                                    ) : (
